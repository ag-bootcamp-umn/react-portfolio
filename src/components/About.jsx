        ...
        <div className="container container--800">
          <article className="grid grid--gap text-center">
            ...
            <p>
              ...
              designing, building and styling apps. It appeals to my interests
              in art and languages: the constant learning of new skills; the
              exploration of diverse ways to apply my knowledge; the embracing
              of challenges; the telling of stories.
            </p>
            <p>
